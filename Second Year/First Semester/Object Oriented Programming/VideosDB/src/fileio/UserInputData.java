...
public final class UserInputData {
    ...
    private Map<String, Double> moviesRating;

    private Map<String, ArrayList<Double>> serialRating;
    ...
    public UserInputData(final String username, final String subscriptionType,
        ...
        this.moviesRating = new HashMap<String, Double>();
        this.serialRating = new HashMap<String, ArrayList<Double>>();
    }
    ...
    public Map<String, Double> getMoviesRating() {
        return moviesRating;
    }
